...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AxoraBD" },
      { name: "description", content: "Axora connects task publishers and earners in one modern platform where users can complete jobs, submit proofs, earn rewards, and manage tasks seamlessly." },
      { property: "og:title", content: "AxoraBD" },
      { name: "twitter:title", content: "AxoraBD" },
      { property: "og:description", content: "Axora connects task publishers and earners in one modern platform where users can complete jobs, submit proofs, earn rewards, and manage tasks seamlessly." },
      { name: "twitter:description", content: "Axora connects task publishers and earners in one modern platform where users can complete jobs, submit proofs, earn rewards, and manage tasks seamlessly." },
