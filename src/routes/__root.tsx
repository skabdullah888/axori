...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AxoraBD (Axora BD) is Bangladesh's trusted micro-task & earning platform. Complete tasks, submit proofs, earn rewards and withdraw easily. Join AxoraBD today." },
      { name: "keywords", content: "axora bd, axorabd, axora, axora bangladesh, axorabd.site, earn money online bangladesh, micro task bangladesh, online income bd" },
      { name: "author", content: "AxoraBD" },
      { name: "robots", content: "index, follow, max-image-preview:large" },
      { property: "og:site_name", content: "AxoraBD" },
      { property: "og:title", content: "AxoraBD - Axora BD | Earn Money Online in Bangladesh" },
      { name: "twitter:title", content: "AxoraBD - Axora BD | Earn Money Online in Bangladesh" },
      { property: "og:description", content: "AxoraBD (Axora BD) is Bangladesh's trusted micro-task & earning platform. Complete tasks, submit proofs, earn rewards and withdraw easily." },
      { name: "twitter:description", content: "AxoraBD (Axora BD) is Bangladesh's trusted micro-task & earning platform." },
